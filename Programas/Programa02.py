...
# Ahora aremos las operaciones pertinentes para hallar nuestra información

superficie=lado*lado

# Por ultimo imprimiremos por pantalla un mensaje junto al resultado.

print ("La superficie del cubo es: ", superficie)
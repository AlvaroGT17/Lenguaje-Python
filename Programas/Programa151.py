...
def imprimirLista(lista):
  for x in range(len(lista)):
    print("El país ", lista[x][0], "tiene una población de: ", lista [x][1], "habitantes.")
...
def mayorPais(lista):
  ...
  for x in range(len(lista)):
    if lista[x][1]>lista[mayor][1]:
      mayor=x
  print("El país ", lista[mayor][0], "es el que más pablación tiene con un número de: ", lista[mayor][1], "habitantes.")
